...
def wdi_get_indicators(language="en", per_page=32500):
    """
    ...
    -----------
        ...
        - `topics`: A nested list containing (possibly multiple) topics associated with the indicator, 
                    with two columns: an integer `topic_id` and a character `topic_value`.
